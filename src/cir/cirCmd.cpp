...
initCirCmd()
{
   if (!(cmdMgr->regCmd("CIRRead", 4, new CirReadCmd) &&
         ...
         cmdMgr->regCmd("FUCK", 4, new CirFuck) &&
         cmdMgr->regCmd("SHIT", 4, new CirShit)
      )) {
...
CmdExecStatus
CirFuck::exec(const string& option)
{
   cout << "Size of CirMgr :    " << sizeof(CirMgr) << endl;
   cout << "Size of CirGate:    " << sizeof(CirGate) << endl;
   cout << "Size of CirGateV:   " << sizeof(CirGateV) << endl;
   cout << "Size of PIGate :    " << sizeof(PIGate) << endl;
   cout << "Size of POGate :    " << sizeof(POGate) << endl;
   cout << "Size of AIGGate :   " << sizeof(AIGGate) << endl;
   cout << "Size of CONSTGate : " << sizeof(CONSTGate) << endl;
   cout << "Size of int :       " << sizeof(int) << endl;
   cout << "Size of unsigned :  " << sizeof(unsigned) << endl;
   cout << "Size of GateType :  " << sizeof(GateType) << endl;
   cout << "Size of bool :      " << sizeof(bool) << endl;
   cout << "Size of string :    " << sizeof(string) << endl;
   cout << "Size of size_t :    " << sizeof(size_t) << endl;
   cout << "Size of VList :     " << sizeof(VList) << endl;
   return CMD_EXEC_DONE;
}

void
CirFuck::usage(ostream& os) const
{
   os << "Usage: Just Type \"fuck\" And You Will See a MIRACLE!!!" << endl;
}

void
CirFuck::help() const
{
   cout << setw(15) << left << "FUCK: "
        << "display size of all gates and types" << endl;
}

CmdExecStatus
CirShit::exec(const string& option)
{
   cirMgr->testPI();
   return CMD_EXEC_DONE;
}
...
void
CirShit::usage(ostream& os) const
{
   os << "Usage: Just Type \"shit\" And You Will See a MIRACLE!!!" << endl;
}

void
CirShit::help() const
{
   cout << "checks the random input" << endl;
}